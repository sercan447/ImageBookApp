...
public class ArtContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "sercandevops.com.professionalartbook.ArtContentProvider";
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            case ARTS:
                ...
                break;
            default:
                throw new IllegalArgumentException("FAILED URI DELETE");
        }
       ...
       int rowCount = 0;
            switch (uriMatcher.match(uri)){
                case ARTS:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("FAİLED URI HATA");
            }
            getContext().getContentResolver().notifyChange(uri,null);
        return rowCount;
